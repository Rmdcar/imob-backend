...
exports.registerImovel = async (req, res) => {
    try{
    const {tipo, cidade, estado, descricao, valor, nome, email, telefone, userId} = req.body;
    const newImovel = new Imob ({tipo, cidade, estado, descricao, valor, nome, email, telefone, userId})
